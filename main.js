...
function nextLink(id, curators, page, count, previous) {
    if (id) {
        ...
        loadPage(page);
        return axios.get("https://cors-proxy.htmldriven.com/?url=https://scratch.mit.edu/site-api/comments/gallery/" + id, {responseType: 'document', params: {page: page}}).then(function (response) {
